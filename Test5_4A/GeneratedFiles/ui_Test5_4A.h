...
public:
    ...
    void setupUi(QMainWindow *Test5_4AClass)
    {
        ...
        btnHelp->setGeometry(QRect(160, 80, 121, 91));
        QIcon icon;
        icon.addFile(QStringLiteral(":/Test5_4A/Resources/help.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnHelp->setIcon(icon);
        btnHelp->setIconSize(QSize(72, 65));
